      ...
      <div className={cx("section-wrapper")}>
        <section className={cx("advise")}>
          ...
          <ul className={cx("adviser-list")}>
            <li style={{"--color-from": "rgba(171, 119, 231, 0.5)", '--color-to': 'rgba(171, 119, 231, 0.75)'}} className={cx("adviser")}>
              <img  src={images["adviser-tuan"]} alt="avatar" />
              <p>Ths Lê Anh Tuấn</p>
            </li>
            <li style={{"--color-from": "rgba(230,161,166, 0.5)", '--color-to': 'rgba(230,161,166, 0.75)'}} className={cx("adviser")}>
              <img  src={images["adviser-hoa"]} alt="avatar" />
              <p>Mr Nguyễn Hữu Thái Hòa</p>
            </li>
            <li style={{"--color-from": "rgba(255,18,18, 0.5)", '--color-to': 'rgba(255,18,18, 0.75)'}} className={cx("adviser")}>
              <img  src={images["adviser-thien"]} alt="avatar" />
              <p>Mr Nguyễn Hoàng Thiện</p>
            </li>
            <li style={{"--color-from": "rgba(13,110,253, 0.5)", '--color-to': 'rgba(13,110,253, 0.75)'}} className={cx("adviser")}>
