...
const realistic = exportQuiz([
  ...
  "Tham gia một chuyến du lịch thám hiểm (như khám pháhang động, núi rừng)",
  "Chăm sóc vật nuôi",
  "Sửa xe",
  "Làm đồ nội thất",
  "Lắp ráp máy vi tính",
  ...
  "Tham gia chuyến đạp xe xuyên quốc gia (từ TPHCM ra HàNội, từ Hà Nội vào TPHCM)",
]);
...
const investigate = exportQuiz([
  ...
  "Đọc một cuốn sách về tương lai của loài ngườitrong một triệu năm nữa",
  ...
  "Đọc các bài báo về ảnh hưởng của AI (trí tuệnhân tạo) lên nghề nghiệp tương lai",
...
const social = exportQuiz([
  ...
  "Giúp bạn bè giải quyết vấn đề liên quan đếntình yêu",
...
const enterprising = exportQuiz([
  ...
  "Tham dự một trại huấn luyện kỹ năng lãnh đạo dành cholứa tuổi thanh thiếu niên",
